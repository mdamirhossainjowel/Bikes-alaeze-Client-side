    ...
    <section>
      <section>
        <div className="hero min-h-screen bg-base-100 lg:w-2/3 mx-auto">
          <div className="hero-content flex-col lg:flex-row">
            ...
            />
            <div>
              <h1 className="text-3xl lg:text-right font-bold mt-3">
                Hi i'm <span className="text-4xl">Md. Amir Hossain Jowel</span>
              </h1>
              <p className="py-2 text-xl lg:text-right">Junior Web Developer.</p>
              <p className="py-2 text-xl lg:text-right">
      ...
      <section className="mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h2 className="text-2xl font-semibold text-center">Programming</h2>
              <img
                className="w-32 mx-auto"
                src={code}
                alt="code specialied"
          ...
          <div className="card bg-base-100 shadow-xl">
            <div className="card-body">
              <h2 className="text-2xl font-semibold text-center">Web Developmet</h2>
              <img
                className="w-32 mx-auto"
                src={web}
                alt="web specialied"
      ...
      <section>
        <div className="card lg:w-2/3 bg-base-100 shadow-xl mx-auto mt-6">
      ...
      <section>
        <div className="card bg-base-100 shadow-xl mx-auto mt-6">
          <h1 className="text-4xl text-center font-semibold text-accent">
            Explore My Projects
          </h1>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                <h2 className="text-2xl font-semibold text-center">KTS Trade</h2>
                <img
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                <h2 className="text-2xl font-semibold text-center">Bikes Alaeze</h2>
                <img
                  className="w-100 mx-auto"
                  src={bikes}
                  alt="web specialied"
