...
console.log(user);
  ...
  <form onSubmit={handleSubmit(onSubmit)}>
    <input  className="input input-bordered input-accent w-full max-w-lg mb-3" value={user.displayName} readOnly placeholder='Full Name' {...register("Name", { required: true})} />
    {errors.Name?.type === 'required' && "Name is required"}
    <input  className="input input-bordered input-accent w-full max-w-lg mb-3" value={user.email} readOnly placeholder='Email'  {...register("Email", { required: true})} />
    ...
    <input  className="input input-bordered input-accent w-full max-w-lg mb-3" value={product.name} readOnly placeholder='Product Name' {...register("Product", { required: true})} />
    ...
    <input  className="input input-bordered input-accent w-full max-w-lg mb-3" value={parseFloat(getValues("Quantity"))*parseFloat(product.price)} placeholder='Price' readOnly type="number"  {...register("Price")} />

    
    <input className="btn btn-primary w-full max-w-lg" disabled={!isValid} type="submit" />
  </form>
